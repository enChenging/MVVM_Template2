        ...
        rxPermissions.requestEachCombined
                ...
                .subscribe(permission -> {
                    if (permission.granted) {
                        ...
                        showNotice(activity, activity.getResources().getString(R.string.login_rationale_wr), isNever);
                    } else {
                        isNever = true;
                        showNotice(activity, activity.getResources().getString(R.string.login_rationale_ask_again), isNever);
                    }
                });
